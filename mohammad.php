...
*/
ob_start();
$API_KEY = '1415309931:AAFNxEuYxa6uzzxPvGjLR3ITx7xqvwefFxw';
...
$alwsh = "@J_69_L";
$sudo = "996310583";
$Dev = array("996310583","",""); //ID ADMIN NUMBER 1 HE CHAT
//****************//
@$usernamebot = "J_69_L"; //UserName Bot
@$channel = "decshell"; // UserName Channel don't @
@$token = API_KEY;
...
$from_id = $message->from->id;
$join = file_get_contents("https://api.telegram.org/bot".API_KEY."/getChatMember?chat_id=@J_69_L&user_id=".$from_id);
...
",
 'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"آلـمـطـور ™",'url'=>"t.me/J_69_L"]],
]])
]);
}}
...
$ar = json_decode(file_get_contents("https://translate.yandex.net/api/v1/tr.json/translate?id=18d57b41.5fe0e283.4ca7b77e.74722d746f756368-3-0&srv=tr-touch&lang=en-ar&reason=auto&text=".$s));
$trar = $ar->text;
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"$trar[0]",
...
if($text=="/ru" and $re){
$s = str_replace(' ','%20',$re->text);
$ru = json_decode(file_get_contents("https://translate.yandex.net/api/v1/tr.json/translate?id=18d57b41.5fe0e283.4ca7b77e.74722d746f756368-3-0&srv=tr-touch&lang=ru-ar&reason=auto&text=".$s));
$trru = $ru->text;
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"$trru[0]",
...
if($text=="/en" and $re){
$s = str_replace(' ','%20',$re->text);
$en = json_decode(file_get_contents("https://translate.yandex.net/api/v1/tr.json/translate?id=18d57b41.5fe0e283.4ca7b77e.74722d746f756368-3-0&srv=tr-touch&lang=ar-en&reason=auto&text=".$s));
$tren = $en->text;
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"$tren[0]",
...
if($text == "/HD" or $text == "/HD@maxsecurtybot" and $re){
bot('sendphoto',[
'chat_id'=>$chat_id,
...
if($text == "/screen" or $text == "/screen@maxsecurtybot" and $re){
$re = $message->reply_to_message;
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"أهلا بك عزيزي في بوت تشفير الرسائل\nمن خلال هذا البوت يمكنك تشفير الرسالة وإرسالها بسريه تامه\n\nلتشفير الرسالة أرسل👇\n\nشفر+ الرساله الذي تريد تشفيرها"
]);
}
$ex = explode("فك",$text);
$en= explode("شفر",$text);
...
إليك الرسالة بعد التشفيير👇\n
$encrypt

لفك شيفرة الرسالة ماعليك 
إلا إرسالها بهذا الطريقة
فك + شيفرة الرسالة"
]);
}
if($ex[1]){
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"تم فك التشفير بنجاح إليك الرسالة👇👇\n\n$decrypt"
]);
}
if($text == "/enc"){
bot('Sendmessage',[
'chat_id'=>$chat_id,
'text'=>"الرجاء ادخال النص المراد تشفيره"
]);
file_put_contents("base64.txt","1");
}
if($text == "/dec"){
bot('Sendmessage',[
'chat_id'=>$chat_id,
'text'=>"الرجاء ادخال النص المراد فك تشفيره"
]);
file_put_contents("base64.txt","2");
}
$base64 = file_get_contents("base64.txt");
if($text != "/dec" and $text != "/enc" and $base64 == "1"){
...
if($text != "/dec" and $text != "/enc" and $base64 == "2"){
...
if($text == "صيح للادمنية" or $text == "تاك للادمنية"){
